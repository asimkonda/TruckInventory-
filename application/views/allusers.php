                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h4 class="card-title">Users Registed</h4>
                                ...
                                <table class="table v-middle">
                                    <thead>
                                        <tr class="bg-light">
                                            ...
                                            <th class="border-top-0">Location Agent</th>
                                    	   ...
                                    	   <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="">
                                                        <h4 class="m-b-0 font-16"><?php echo $value->user_fname;  ?></h4>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <label class="label label-danger"><?php echo $value->user_uname;  ?></label>
                                            </td>
                                            <td>


                                            <?php echo anchor('welcome','Update',['class'=>'btn btn-outline-success']);  ?>
                                            <?php echo anchor('welcome/deleteuser','Delete',['class'=>'btn btn-outline-danger']);   ?>
